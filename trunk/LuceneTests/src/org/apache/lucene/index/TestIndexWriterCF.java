 ...
 */
public class TestIndexWriterCF extends BaseTokenStreamTestCase {
    public TestIndexWriterCF(String name) {
    ...
    */
    public void testAddIndexOnDiskFull() throws IOException
    {
      ...
      assertEquals("first docFreq", 114, reader.colDocFreq(searchTerm));
      ...
      for(int iter=0;iter<6;iter++) {
        ...
        while(!done) {
          ...
          for(int x=0;x<2;x++) {
            ...
            int resultCF = reader.colDocFreq(searchTerm);
            if (success) {
              ...
              if (autoCommit && resultCF != END_COUNT * 2) {
                  fail(testName + ": method did not throw exception but docFreq('aaa') is " + result + " instead of expected " + END_COUNT);
                } else if (!autoCommit && resultCF != START_COUNT * 2) {
                  fail(testName + ": method did not throw exception but docFreq('aaa') is " + result + " instead of expected " + START_COUNT + " [autoCommit = false]");
                }
    ...
    */
    public void testWickedLongTerm() throws IOException {
      ...
      assertEquals(2, tps.freq()); //AIP comment: in this case the freq in the doc is asked, after my modification is 2 instead of 1
