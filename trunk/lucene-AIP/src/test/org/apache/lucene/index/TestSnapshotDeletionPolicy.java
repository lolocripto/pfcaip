...
//    runTest(dir2);
  ...
  public void testReuseAcrossWriters() throws Exception {
    ...
    IndexWriter writer = new IndexWriter(dir, new StandardAnalyzer(org.apache.lucene.util.Version.LUCENE_30), dp, IndexWriter.MaxFieldLength.UNLIMITED);
    ...
    writer = new IndexWriter(dir, new StandardAnalyzer(org.apache.lucene.util.Version.LUCENE_30), dp, IndexWriter.MaxFieldLength.UNLIMITED);
    copyFiles(dir, cp);
    for(int i=0;i<7;i++) {
      writer.addDocument(doc);
      if (i % 2 == 0) {
  ...
  private void runTest(Directory dir) throws Exception {
    ...
    SnapshotDeletionPolicy dp = new SnapshotDeletionPolicy(new KeepOnlyLastCommitDeletionPolicy());
    final IndexWriter writer = new IndexWriter(dir, new StandardAnalyzer(org.apache.lucene.util.Version.LUCENE_30), dp, IndexWriter.MaxFieldLength.UNLIMITED);
