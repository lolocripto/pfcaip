...
public class LMKCDBooleanWeight extends Weight {
    ...
    public LMKCDBooleanWeight(BooleanTermQuery[] should,
...
//	@Override
	public Scorer scorer(IndexReader reader) throws IOException {
		return new LMKCDSingleBooleanScorer(reader, this.unique, new LMKCDSimilarity());
	}
