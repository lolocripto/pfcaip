...
public class TestSpansAdvanced extends LuceneTestCase {
    ...
    protected void setUp() throws Exception {
        ...
        final IndexWriter writer = new IndexWriter(mDirectory, new StandardAnalyzer(org.apache.lucene.util.Version.LUCENE_30), true, IndexWriter.MaxFieldLength.LIMITED);
