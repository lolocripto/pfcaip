...
public class TestSpansAdvanced2 extends TestSpansAdvanced {
    ...
    protected void setUp() throws Exception {
        ...
        // create test index
        final IndexWriter writer = new IndexWriter(mDirectory, new StandardAnalyzer(org.apache.lucene.util.Version.LUCENE_30), false, IndexWriter.MaxFieldLength.LIMITED);
