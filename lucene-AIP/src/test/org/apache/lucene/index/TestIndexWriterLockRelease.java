...
public class TestIndexWriterLockRelease extends LuceneTestCase {
    ...
    public void testIndexWriterLockRelease() throws IOException {
        ...
        try {
            im = new IndexWriter(dir, new org.apache.lucene.analysis.standard.StandardAnalyzer(org.apache.lucene.util.Version.LUCENE_30), false, IndexWriter.MaxFieldLength.LIMITED);
