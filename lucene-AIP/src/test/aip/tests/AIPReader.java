...
/**
 * Esta clase muestra el contenido de un indice Los tamaños mostrados estan
 * medidos en numero de terminos
 */
public class AIPReader {
	...
	public static void main(String[] args) throws Exception {
		...
		read2(AIPTestUtils.INDEX_DIR_TREC_SHORT);
	}
	...
	public static void read(String indexDir) throws Exception {
		...
		// obtenemos el objeto "IndexReader" que incorpora todos los datos del
		// indice
		...
		// Tamaño del campo "catchAll", lo que significa tamaño de cada
		// documento
		/*
		...
		for (TermEnum termEnum = idx.terms(); termEnum.next();) {
			...
			if (field.equals(Constants.CATCHALL_FIELD)) {
				...
				System.out.println("     Termino[" + text + "] doc. frequency[" + docFreq + "] colection freq [" + colFreq + "]");
	...
	public static void read2(String indexDir) throws Exception {
...
//		}
		...
		System.out.println("     Termino[post] doc. frequency[" + idx.colDocFreq("post") + "] colection freq [" + idx.docFreq("post") + "]");
		idx.close();
	}
}