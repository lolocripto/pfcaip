...
final class DocumentsWriter {
  ...
  // AIP comment: este atributo contiene otro que tiene los nombres de los ficheros a escribir
   ...
   * AIP comment: "flushedFiles" contains the names of the files to be added to the 
   * 		compound file.
   * */
